...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(shape=(self.config.batch_size, self.config.n_features), dtype=np.float32)
        self.labels_placeholder = tf.placeholder(shape=(self.config.batch_size, self.config.n_classes), dtype = np.float32)
        ### END YOUR CODE
